    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Assets Request</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Assets & Spare Part Request</h6>
        </nav>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Tix</p>
                                <h5 class="font-weight-bolder">
                                    ...
                                    $this->db->where('jenis_komplain', $category);
                ...
                <div class="card-header pb-0 p-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn bg-gradient-danger ms-1 btn-custom" onclick="printReport()">
                            <input type="hidden" name="" id="aWal" value="<?= $awal ?>">
                            <input type="hidden" name="" id="aKhir" value="<?= $akhir ?>">
...
<script>
    ...
    function printReport() {
        var wal = $("#aWal").val();
        var khir = $("#aKhir").val();
        var linkz = "<?= base_url('ReportPdf/printReportAr_Filtered/') ?>" + wal + "/" + khir;
