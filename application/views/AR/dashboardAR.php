    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Asset Request</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Asset Request</h6>
        </nav>
            ...
            <div class="card">
                <div class="card-header pb-0 p-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-dark ms-auto btn-custom" data-bs-toggle="modal" data-bs-target="#filterDate">
                            <span class="btn-icon"><i class="fas fa-calendar-alt"></i></span>
                            <span class="btn-text ms-1"> Search By Date..</span>
                        </button>
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    ...
                    <form action="<?= site_url('AssetReq/updateTask') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    ...
                    <form action="<?= site_url('AssetReq/proposeRF') ?>" method="post" enctype="multipart/form-data" id="formBA">
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    ...
                    <form action="<?= site_url('AssetReq/searchTix_Cat') ?>" method="post">
                        <div class="card-body">
                            <input type="hidden" class="form-control" value="AR" name="category">
                            <div class="form-group">
...
<script>
    $(document).on("click", ".task", function() {
        ...
        $(".problem").html('<p class="mb-0 problem">Reqest for : ' + info[0] + ' ' + info[1] + ' ' + info[2] + '</p>');
        $(".estimate").html('<p class="mb-0 problem">Additional Info : ' + info[3] + '</p>');
    ...
    $(document).on("click", ".track", function() {
        ...
        jQuery.ajax({
            url: "<?= base_url(); ?>AssetReq/checkDbTicket",
            data: 'noticket=' + tix,
            type: "POST",
    ...
    $(document).on("click", ".proposeBA", function() {
        ...
        console.log(period);
        $.ajax({
            url: '<?= base_url() ?>index.php/AssetReq/getNoBeritaAcara',
            method: 'POST',
            data: {
                // lbl: lbl,
                period: period,
    ...
    function printReport() {
        var linkz = "<?= base_url('ReportPdf/printReportAr') ?>";
