        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    ...
                    <form action="<?= site_url('Troubleshoot/searchTix_Cat') ?>" method="post">
                        <div class="card-body">
                            <input type="hidden" class="form-control" value="TS" name="category">
                            <div class="form-group">
...
<script>
    ...
    function printReport() {
        var wal = $("#aWal").val();
        var khir = $("#aKhir").val();
        var linkz = "<?= base_url('ReportPdf/printReportTs_Filtered/') ?>" + wal + "/" + khir;
